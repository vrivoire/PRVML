...
public class Main {
    ...
    public static void init(ConfigurableApplicationContext context) throws Exception {
        ...
        try {
            ...
            availability = new Availability(Timestamp.valueOf("2019-07-02 14:00:00"), Timestamp.valueOf("2019-07-02 14:45:00"));
            availabilityRepository.saveAndFlush(availability);
            professional1.addAvailability(availability);

            availabilityRepository = context.getBean(AvailabilityRepository.class);
            availability = new Availability(Timestamp.valueOf("2019-07-03 10:30:00"), Timestamp.valueOf("2019-07-03 11:45:00"));
            availabilityRepository.saveAndFlush(availability);
            professional2.addAvailability(availability);

            availability = new Availability(Timestamp.valueOf("2019-07-04 09:00:00"), Timestamp.valueOf("2019-07-04 10:00:00"));
            availabilityRepository.saveAndFlush(availability);
            professional2.addAvailability(availability);
